                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                                {Object.entries(selectedScan.layers).map(([key, val]) => (
                                                    <div key={key} className="bg-slate-950/30 border border-slate-800/50 p-3 rounded-xl text-center">
                                                        <span className="text-[8px] font-bold text-slate-500 uppercase block mb-1">{key}</span>
                                                        <span className={`text-xs font-bold ${val > 70 ? 'text-red-500' : val > 30 ? 'text-yellow-500' : 'text-emerald-500'}`}>
                                                            {val}%
                                                        </span>
                                                    </div>
                                                ))}
